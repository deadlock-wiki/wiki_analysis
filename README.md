...
- `top 10 editors` - fetches the top 10 editors from the last 7 days on the deadlock wikipedia
- `top 10 new page creators` - fetches the top 10 new page creators on the deadlock wikipedia
### How to run
```bash
